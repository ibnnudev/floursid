 ...
 <footer class="bg-white hidden md:block" aria-labelledby="footer-heading">
     ...
     <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16">
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-24 mb-8">
             ...
             <div class="col-span-2 grid grid-cols-1 lg:grid-cols-6 gap-3 items-center text-primary">
                 <div class="w-full">
                     <a href="">Chi Siamo</a>
                 </div>
                 <div class="w-full">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-24 mb-8">
             ...
             <div class="col-span-2 grid grid-cols-1 lg:grid-cols-6 gap-3 text-primary">
                 <div class="space-y-4">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-24 mb-8 items-end">
             ...
             <div class="col-span-2 grid md:grid-cols-2 gap-10 items-center text-primary">
                 ...
                 <div class="flex items-center gap-4">
                     <div class="w-11 h-11 p-3 rounded-full flex items-center justify-center bg-primary">
                         <i class="fab fa-instagram text-white w-6 h-6"></i>
                     </div>
                     <div class="w-11 h-11 p-3 rounded-full flex items-center justify-center bg-primary">
                         <i class="fab fa-linkedin-in text-white w-6 h-6"></i>
                     </div>
                     <div class="w-11 h-11 p-3 rounded-full flex items-center justify-center bg-primary">
                         <i class="fab fa-facebook-f text-white w-6 h-6"></i>
                     </div>
                     <div class="w-11 h-11 p-3 rounded-full flex items-center justify-center bg-primary">
                         <i class="fab fa-wikipedia-w text-white w-6 h-6"></i>
                     </div>
                 </div>
             </div>
         </div>
