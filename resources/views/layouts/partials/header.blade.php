<!-- header -->
<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 mt-10">
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="#"
                        class="flex items-center py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-primary md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                        <img src="{{ asset('assets/images/icon_contact.png') }}" width="30" height="30"
                            alt="">
